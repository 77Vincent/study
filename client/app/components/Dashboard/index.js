      ...
      <div className='Dashboard'>
        <Layout>
          ...
          <Layout.Content className='Dashboard-Content App-tile'>
            <Route exact path="/dashboard" component={Components.Info}/>
            <Route path="/dashboard/schedule" component={Components.Schedule} />
            <Route path="/dashboard/order" component={Components.Order} />
          </Layout.Content>
        </Layout>
      </div>
    );
